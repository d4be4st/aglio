        ...
        for (m = 0, len4 = ref4.length; m < len4; m++) {
          ...
          results1.push((function() {
            ...
            for (n = 0, len5 = ref5.length; n < len5; n++) {
              ...
              if (action.content) {
                var ref20, len20, dataStructure, tempDS;
                ref20 = action.content;
                for (v = 0, len20 = ref20.length; v < len20; v++) {
                  dataStructure = ref20[v];
                        ...
                        for (r = 0, len9 = ref8.length; r < len9; r++) {
                          ...
                          if (item.content && !process.env.DRAFTER_EXAMPLES) {
                            ...
                            for (u = 0, len12 = ref11.length; u < len12; u++) {
                              ...
                              if (dataStructure.element === 'dataStructure' && action.method !== "GET") {
                                try {
